...
public:
	static iso_type_status check_type(const std::string& path, std::array<u8, 16>* dec_key = nullptr);
	static iso_integrity_status check_integrity(const std::string& path);
