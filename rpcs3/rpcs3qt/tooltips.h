...
public:
	...
	const struct settings
	{
		...
		const QString use_recursive_scan           = tr("Enables use of recursive scan on subfolders when adding or scanning contents from the selected folder.\nWhen disabled, contents are scanned only on the selected folder.");
